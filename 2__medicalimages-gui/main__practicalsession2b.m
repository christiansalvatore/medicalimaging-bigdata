...
% Practical session #2b | #nifti #mri
...
gm = load_nii('data/single-patient/MRI/mwp1-mri.nii');
...
gm = load_nii('data/single-patient/MRI/mwp1-mri.nii');
wm = load_nii('data/single-patient/MRI/mwp2-mri.nii');
wb = load_nii('data/single-patient/MRI/wm-mri.nii');
...
path = 'data/multiple-patients/MRI/';
